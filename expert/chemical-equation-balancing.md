...
```
                     ...
                     (γ)
                     (δ)
(0, 3, -4, -2, -1) * (η) = 0 <=> 3β - 4γ -2δ - η = 0 (4)
```

So we have got this equation system :
...
But we have 5 unknowns for 4 equations.
